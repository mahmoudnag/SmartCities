...
namespace SmartCities.EF.Migrations
{
    ...
    [Migration("20240411221307_6april2")]
    partial class _6april2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartCities.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f715588-b41f-4ff2-a245-040136cdd33d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEL9qTnJREtOot3FUIXujBoiFR2z4ba8YpcY0mfsnVCYIIRfw7FAycpfMMYsBk5EOzQ==",
                            PhoneNumber = "01026691741",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "50661369-e91f-406d-9675-c5c2cc37c4c3",
            ...
            modelBuilder.Entity("SmartCities.Core.Models.ProjectTeam", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SmartCities.Core.Models.ProjectTeam", b =>
                {
                    b.HasOne("SmartCities.Core.Models.Project", "project")
                        .WithMany("ProjectTeams")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartCities.Core.Models.Team", "Teams")
                        .WithMany("ProjectTeams")
